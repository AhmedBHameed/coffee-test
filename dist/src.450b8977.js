...
},{"./cjs/react-dom.production.min.js":"i17t"}],"Q40o":[function(require,module,exports) {
'use strict';
...
},{}],"R6xY":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./hyphenate":"Q40o"}],"YOxv":[function(require,module,exports) {
var define;
/*
 *          __        ___
 *    _____/ /___  __/ (_)____
...
},{"./factoryWithThrowingShims":"wVGV"}],"89El":[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-is.production.min.js":"RsE0"}],"pBGv":[function(require,module,exports) {
...
exports.__DO_NOT_USE_OR_YOU_WILL_BE_HAUNTED_BY_SPOOKY_GHOSTS = exports.StyleSheetManager = exports.ServerStyleSheet = exports.withTheme = exports.ThemeProvider = exports.injectGlobal = exports.keyframes = exports.css = exports.default = void 0;
  ...
  return chunks.reduce(function (ruleSet, chunk) {
    ...
    if (typeof chunk === 'function') {
      if (executionContext) {
        ...
        if (_react.default.isValidElement(nextChunk)) {
...
StyleSheetManager.childContextTypes = (_StyleSheetManager$ch = {}, _StyleSheetManager$ch[CONTEXT_KEY] = _propTypes.default.oneOfType([_propTypes.default.instanceOf(StyleSheet), _propTypes.default.instanceOf(ServerStyleSheet)]).isRequired, _StyleSheetManager$ch);
...
var contextShape = (_contextShape = {}, _contextShape[CHANNEL] = _propTypes.default.func, _contextShape[CHANNEL_NEXT] = CONTEXT_CHANNEL_SHAPE, _contextShape);
...
var modifiedContextShape = _extends({}, contextShape, (_babelHelpers$extends = {}, _babelHelpers$extends[CONTEXT_KEY] = _propTypes.default.oneOfType([_propTypes.default.instanceOf(StyleSheet), _propTypes.default.instanceOf(ServerStyleSheet)]), _babelHelpers$extends));
...
var BaseStyledComponent = function (_Component) {
  ...
  BaseStyledComponent.prototype.buildExecutionContext = function buildExecutionContext(theme, props) {
    ...
    this.attrs = Object.keys(attrs).reduce(function (acc, key) {
      ...
      acc[key] = typeof attr === 'function' && !hasInInheritanceChain(attr, _react.Component) ? attr(context) : attr;
      return acc;
    }, {});
  ...
  BaseStyledComponent.prototype.generateAndInjectStyles = function generateAndInjectStyles(theme, props) {
    ...
    if (componentStyle.isStatic && attrs === undefined) {
      ...
      if ("production" !== 'production' && warnTooManyClasses !== undefined) {
...
var _StyledComponent = function (ComponentStyle, constructWithOptions) {
  var createStyledComponent = function createStyledComponent(target, options, rules) {
    ...
    if (isClass) {
      (0, _hoistNonReactStatics.default)(StyledComponent, target, {
...
},{"fbjs/lib/hyphenateStyleName":"R6xY","react":"1n8/","stylis":"YOxv","stylis-rule-sheet":"UYYs","prop-types":"5D9O","hoist-non-react-statics":"89El","react-is":"H1RQ","process":"pBGv"}],"3YQn":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Settings(props) {
    ...
    _this.increaseCup = _this.increaseCup.bind(_assertThisInitialized(_this));
    _this.decreaseCup = _this.decreaseCup.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(Settings, [{
    key: "increaseCup",
    value: function increaseCup(e) {
      e.stopPropagation();
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h5", null, "Number of cups:"), _react.default.createElement(CupSettings, null, _react.default.createElement("div", {
        className: "cup-num-input"
...
},{"react":"1n8/","styled-components":"tFSs"}],"ARYv":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Description(props) {
    ...
    _this.saveDescriptionSetting = _this.saveDescriptionSetting.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(Description, [{
    key: "saveDescriptionSetting",
    value: function saveDescriptionSetting() {
    ...
    key: "render",
    value: function render() {
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("h3", null, "How to play the coffee game:"), _react.default.createElement("p", null, "The cups will fill from time to time. You can drink them empty by clicking on a cup. Try to drink all cups before they get too full. The speed of the filling process will increase after time."), _react.default.createElement("div", null, _react.default.createElement("input", {
        type: "checkbox",
        defaultValue: false,
        onChange: this.saveDescriptionSetting
      }), _react.default.createElement("span", null, "Don't show this description again")), _react.default.createElement("button", {
        className: "actionButton txt-center",
        onClick: this.props.onStart
      }, "Start"));
    }
  }]);
...
},{"react":"1n8/"}],"R2W4":[function(require,module,exports) {

},{}],"8jJz":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Container, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "container".concat(!!className ? " ".concat(className) : "")
      }, children);
    }
  }]);
...
},{"react":"1n8/"}],"taN8":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(FlexWrapper, _React$Component);

  function FlexWrapper(props) {
    _classCallCheck(this, FlexWrapper);

    return _possibleConstructorReturn(this, _getPrototypeOf(FlexWrapper).call(this, props));
  }

  _createClass(FlexWrapper, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          className = _this$props.className,
          children = _this$props.children;
      return _react.default.createElement("div", {
        className: "flex-box ".concat(className)
      }, children);
    }
  }]);
...
},{"react":"1n8/"}],"qNsK":[function(require,module,exports) {
"use strict";
...
var BrandWithLogo = _styledComponents.default.div(_templateObject2());

var HighScore = _styledComponents.default.h5(_templateObject3());
...
function (_React$Component) {
  ...
  _createClass(NavBar, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Header, null, _react.default.createElement(BrandWithLogo, null, _react.default.createElement("div", null, "Coffee game"), _react.default.createElement("img", {
        src: imgSrc,
        alt: "caffee",
        className: "gameLogo"
      })), _react.default.createElement(HighScore, null, "Highest Score: ", this.getHighScore(), "s"));
    }
  }]);
...
},{"react":"1n8/","styled-components":"tFSs"}],"ko63":[function(require,module,exports) {
module.exports = "/cup_empty.62c83817.png";
},{}],"NiPx":[function(require,module,exports) {
module.exports = "/cup_fill_1.a3d8b51e.png";
},{}],"JMnF":[function(require,module,exports) {
module.exports = "/cup_fill_2.606cb127.png";
},{}],"evXf":[function(require,module,exports) {
module.exports = "/cup_full.867df466.png";
},{}],"+wBe":[function(require,module,exports) {
module.exports = "/cup_too_full.7fa8829d.png";
},{}],"saY2":[function(require,module,exports) {
"use strict";
...
var _cup_empty = _interopRequireDefault(require("../assets/cup_empty.png"));

var _cup_fill_ = _interopRequireDefault(require("../assets/cup_fill_1.png"));

var _cup_fill_2 = _interopRequireDefault(require("../assets/cup_fill_2.png"));

var _cup_full = _interopRequireDefault(require("../assets/cup_full.png"));

var _cup_too_full = _interopRequireDefault(require("../assets/cup_too_full.png"));
...
var CupWrapper = _styledComponents.default.div(_templateObject());

var CupButton = _styledComponents.default.button(_templateObject2());

var TimerWrapper = _styledComponents.default.span(_templateObject3());
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(Cup, _React$Component);
  ...
  function Cup(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Cup).call(this, props));
    _this.state = {
      assetNumber: 0,
      coeff: _this.props.defaultTimeout | 1000,
      timeout: _this.initTimeout(),
      timer: 0,
      stepTimer: 0,
    ...
    _this.emptyCup = _this.emptyCup.bind(_assertThisInitialized(_this));
    _this.fillCup = _this.fillCup.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Cup, [{
    ...
    value: function componentDidMount() {
      this.DOMElement = _reactDom.default.findDOMNode(this);
    ...
    value: function (_setTimeout) {
      ...
      this.stepChrono = setTimeout(function () {
        return _this2.fillCup();
      }, this.state.timeout);
    })
  }, {
    key: "setTimeInterval",
    value: function setTimeInterval() {
      ...
      this.chrono = setInterval(function () {
        _this3.setState({
          timer: _this3.state.timer + 0.01,
          stepTimer: _this3.state.stepTimer + 0.01
        });
      }, 10);
    }
  }, {
    key: "pauseOrPlayGame",
    value: function pauseOrPlayGame(newProps) {
      var isGameover = newProps.isGameover,
          gamePause = newProps.gamePause;
    ...
    value: function setHighScore() {
      var oldHighScore = localStorage.getItem("highScore") || 0;
      var newHightScore = +(+this.gameScore > oldHighScore ? this.gameScore : oldHighScore);
    ...
    key: "emptyCup",
    value: function emptyCup() {
      var _this$props = this.props,
          gamePause = _this$props.gamePause,
          isGameover = _this$props.isGameover;
      if (!isGameover && !gamePause && !this.state.overflow) this.setState({
        assetNumber: 0,
    ...
    value: function renderTimer() {
      var time = Math.round(this.state.timer * 100) / 100;
...
exports.default = Cup;
},{"react":"1n8/","react-dom":"NKHc","styled-components":"tFSs","../assets/cup_empty.png":"ko63","../assets/cup_fill_1.png":"NiPx","../assets/cup_fill_2.png":"JMnF","../assets/cup_full.png":"evXf","../assets/cup_too_full.png":"+wBe"}],"YfQh":[function(require,module,exports) {
"use strict";
...
var _cup = _interopRequireDefault(require("./cup.jsx"));

var _flexWrapper = _interopRequireDefault(require("./flex-wrapper"));
...
var CupFlex = (0, _styledComponents.default)(_flexWrapper.default)(_templateObject());

var GameOver = _styledComponents.default.h2(_templateObject2());

var GamePaused = _styledComponents.default.h2(_templateObject3());

var ColumnFlex = _styledComponents.default.div(_templateObject4());
...
function (_React$Component) {
  ...
  function GameWrapper(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GameWrapper).call(this, props));
    _this.state = {
      gamePause: false
    };
  ...
  _createClass(GameWrapper, [{
    ...
    key: "gameActions",
    value: function gameActions() {
      var _this$props = this.props,
          gameover = _this$props.gameover,
          setSettings = _this$props.setSettings,
          handleStart = _this$props.handleStart;
      var gamePause = this.state.gamePause;
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(ColumnFlex, {
        className: "columnFlex"
      }, gamePause && _react.default.createElement(GamePaused, null, "GAME PAUSED"), gameover && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(GameOver, null, "GAME OVER"), _react.default.createElement("button", {
        className: "actionButton",
        onClick: handleStart
      }, "Retry"), _react.default.createElement("button", {
        className: "actionButton",
        onClick: function onClick() {
          return setSettings();
        }
      }, "Change settings"))), !gameover && _react.default.createElement("button", {
        className: "actionButton",
    ...
    key: "renderCups",
    value: function renderCups() {
      var _this$props2 = this.props,
          setGameOver = _this$props2.setGameOver,
          defaultTimeout = _this$props2.defaultTimeout,
          nbCups = _this$props2.nbCups,
          gameover = _this$props2.gameover;
      var gamePause = this.state.gamePause;
      var cups = [];

      for (var i = 0; i < nbCups; i++) {
        cups.push(_react.default.createElement(_cup.default, {
          key: i.toString(),
          isGameover: gameover,
          gamePause: gamePause,
      ...
      return _react.default.createElement(CupFlex, null, cups);
    }
  }, {
    key: "render",
    value: function render() {
      return _react.default.createElement(Content, null, this.renderCups(), this.gameActions());
    }
  }]);
...
},{"react":"1n8/","styled-components":"tFSs","./cup.jsx":"saY2","./flex-wrapper":"taN8"}],"frDw":[function(require,module,exports) {
"use strict";
...
var _description = _interopRequireDefault(require("./components/description.jsx"));

var _styledComponents = _interopRequireDefault(require("styled-components"));

require("./stylesheet/game.css");

var _container = _interopRequireDefault(require("./components/container"));

var _flexWrapper = _interopRequireDefault(require("./components/flex-wrapper"));

var _navBar = _interopRequireDefault(require("./components/nav-bar"));

var _gameWapper = _interopRequireDefault(require("./components/game-wapper"));
...
var FlexBox = (0, _styledComponents.default)(_flexWrapper.default)(_templateObject());
var FlexBoxWrapper = (0, _styledComponents.default)(_flexWrapper.default)(_templateObject2());
...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.state = {
      restartGame: true,
      nbCups: 1,
      incNbCups: function incNbCups() {
        _this.setState({
          nbCups: _this.state.nbCups < 8 ? ++_this.state.nbCups : _this.state.nbCups
        });
      },
      decNbCups: function decNbCups() {
        _this.setState({
          nbCups: _this.state.nbCups > 1 ? --_this.state.nbCups : _this.state.nbCups
        });
      },
      noDescription: false,
    ...
    _this.updateNbCups = _this.updateNbCups.bind(_assertThisInitialized(_this));
    _this.setGameOver = _this.setGameOver.bind(_assertThisInitialized(_this));
  ...
  _createClass(Game, [{
    key: "updateNbCups",
    value: function updateNbCups(e) {
      e.preventDefault();
      var newVal = +e.target.value.charAt(1);
    ...
    value: function renderSettings() {
      return _react.default.createElement(_settings.default, {
    ...
    value: function renderDescription() {
      ...
      return _react.default.createElement("div", {
        ...
        onStart: function onStart(e) {
          return _this2.handleStart(e, true);
        }
      }));
    }
  }, {
    key: "handleStart",
    value: function handleStart(e, gameTime) {
      var _this3 = this;

      this.state.gameover = false;
      gameTime || localStorage.getItem("noDescription") == "true" ? this.setState({
        gameTime: true,
        descriptionTime: false
      }) : this.setState({
        gameTime: false,
    ...
    key: "setGameOver",
    value: function setGameOver(gameoverState) {
      this.setState({
    ...
    value: function render() {
      var _this$state = this.state,
          gameTime = _this$state.gameTime,
          descriptionTime = _this$state.descriptionTime,
      ...
      return _react.default.createElement(FlexBoxWrapper, null, _react.default.createElement(_navBar.default, {
        ...
        gameover: gameover
      }), _react.default.createElement(_container.default, null, _react.default.createElement(FlexBox, null, gameTime && restartGame && _react.default.createElement(_gameWapper.default, {
        nbCups: nbCups,
        gameover: gameover,
        gameTime: gameTime,
      ...
      }), descriptionTime && this.renderDescription(), !gameTime && !descriptionTime && this.renderSettings())));
    }
  }]);
...
},{"react":"1n8/","./components/settings.jsx":"3YQn","./components/description.jsx":"ARYv","styled-components":"tFSs","./stylesheet/game.css":"R2W4","./components/container":"8jJz","./components/flex-wrapper":"taN8","./components/nav-bar":"qNsK","./components/game-wapper":"YfQh","./assets/cup_too_full.png":"+wBe"}],"/deH":[function(require,module,exports) {
"use strict";
...
if (module.hot) {
  //dev mode
  _reactDom.default.render(_react.default.createElement(_game.default, null), document.getElementById("root"));
